function defineData(){
    ...
    maleData =[
        ["運動や筋トレはしていますか？　
","体が引き締まると、自信がつきます。最初は軽い運動や負荷の少ない筋トレを習慣にしていくといいでしょう。ジムに行ってみるのもおすすめです。"],
        ["眉毛は整えていますか？　","眉毛を整えるだけでも清潔感が出ます。動画などを参考にして処理したり、理容室に行ったりしてみるといいでしょう。"],
        ["体臭対策はしていますか？　
","体臭は清潔感の大敵です。お風呂に毎日入ることだけでなく、汗拭きシートを使用したり、洗濯をこまめに行いましょう。また、制汗剤や香水は、使用しすぎると逆効果になることもあるため注意が必要です。"],
